...
function CharacterCard({ character }: { character: Character }) {
  return (
    <div className="flex flex-col mx-3 items-center justify-start bg-white border border-gray-200 rounded-lg shadow sm:mx-0 sm:flex-row md:max-w-xl  hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
      <img
